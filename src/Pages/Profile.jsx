...
//     // ✅ Yahan pe hum Users collection se correct document fetch kar rahe hain
...
//     // ✅ Avatar aur Cover fetch karna
//     if (userDoc.avatarURL) {
//       setAvatarUrl(appwriteService.getFileView(userDoc.avatarURL));
//     } else if (userDoc.avatar) {
//       // agar tumne purane code me avatar field alag name se rakhi hai
//       setAvatarUrl(appwriteService.getFileView(userDoc.avatar));
//     }

//     if (userDoc.coverURL) {
//       setCoverUrl(appwriteService.getFileView(userDoc.coverURL));
//     } else if (userDoc.cover) {
//       setCoverUrl(appwriteService.getFileView(userDoc.cover));
//     }

//     // ✅ Posts fetch karna
//     let query = [Query.equal("userid", profileUserId)];
//     if (!isOwnProfile) {
//       query.push(Query.equal("status", "public"));
//     }
...
// {/* Avatar + Name + Bio in One Left-Aligned Column */}
...
//   {profileUser.bio && (
//     <p className="text-black bold">{profileUser.bio}</p>
//   )}
...
//       src={FirstPost}
//       alt="No posts yet"
//       className="w-150 mx-auto object-contain"
//     />
